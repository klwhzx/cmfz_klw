	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
                $.post("${pageContext.request.contextPath}/code/codes",function (result){
                    $("#captchaImage").attr("src","${pageContext.request.contextPath}/code/codes");
                })
            });
		});
	</script>
				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  name="tel" class="text" value="xxx" maxlength="20"/>
							</td>
					  </tr>
					  <tr>
							<th>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/code/codes" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
